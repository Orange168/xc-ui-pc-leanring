              ...
              <div class="course-weeklist">
                <div class="nav nav-stacked" v-for="(teachplan_first, index) in teachplanList">
                  <div class="tit nav-justified text-center">
                    <i class="pull-left glyphicon glyphicon-th-list"></i>{{teachplan_first.pname}}<i class="pull-right"></i></div>
      ...
      study(chapter){
        courseApi.get_media(this.courseId,chapter).then(res=>{
          if (res.success){
            ...
            // this.playvideo('http://video.xuecheng.com/video/a/5/a5b6a164659567f1b172e9a8943790d7/hls/a5b6a164659567f1b172e9a8943790d7.m3u8');
            console.log('--------------------------------\n' + videoUrl);
          }else if (res.message) {
