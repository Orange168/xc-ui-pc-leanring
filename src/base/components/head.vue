        ...
        <div class="">
          ...
          <div class="nav-list">
            <ul class="nav navbar-nav">
              <li ><a href="http://xuecheng.linz.tech/">首页</a></li>
              <li><a href="http://xuecheng.linz.tech/course/search">课程</a></li>
              <li><a href="#">职业规划</a></li>
              <li></li>
            </ul>
          </div>
...
<script type="text/javascript">
  ...
  export default {
    ...
    methods: {
      search() {
        if (this.keyword === '') {
          window.location = "http://xuecheng.linz.tech/course/search"
        } else {
          let keyword = encodeURIComponent(this.keyword)
          window.location = "http://xuecheng.linz.tech/course/search?keyword="+keyword
        }
      },
      //退出登录
      logout: function () {
